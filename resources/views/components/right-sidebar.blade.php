              ...
              <li class="dt-list__item">
                <div class="choose-option">
                  <a href="../default" target="_blank" class="choose-option__icon">
                    <img src="images/layouts/fixed.png" alt="Fixed Layout">
                  </a>
                </div>
              </li>
              <li class="dt-list__item">
                <div class="choose-option">
                  <a href="../mini-sidebar" target="_blank" class="choose-option__icon">
                    <img src="images/layouts/mini-sidebar.png" alt="Mini Layout">
                  </a>
                </div>
              </li>
              <li class="dt-list__item">
                <div class="choose-option">
                  <a href="../drawer" target="_blank" class="choose-option__icon">
                    <img src="images/layouts/drawer-nav.png" alt="Drawer Nav Layout">
                  </a>
                </div>
              </li>
              <li class="dt-list__item">
                <div class="choose-option">
                  <a href="../back-office-mini" target="_blank" class="choose-option__icon">
                    <img src="images/layouts/no-header-mini-sidebar.png" alt="No Header Mini Sidebar Layout">
                  </a>
                </div>
              </li>
              <li class="dt-list__item">
                <div class="choose-option">
                  <a href="../back-office" target="_blank" class="choose-option__icon">
                    <img src="images/layouts/vertical-no-header.png" alt="Vertical No Header Layout">
                  </a>
                </div>
              </li>
              <li class="dt-list__item">
                <div class="choose-option">
                  <a href="../horizontal" target="_blank" class="choose-option__icon">
                    <img src="images/layouts/horizontal-default.png"
              ...
              <li class="dt-list__item">
                <div class="choose-option">
                  <a href="../horizontal-dark" target="_blank" class="choose-option__icon">
                    <img src="images/layouts/horizontal-dark.png" alt="Horizontal Dark Layout">
                  </a>
                </div>
              </li>
              <li class="dt-list__item">
                <div class="choose-option">
                  <a href="../horizontal-inside-nav" target="_blank" class="choose-option__icon">
                    <img src="images/layouts/horizontal-inside-nav.png" alt="Horizontal Inside Nav Layout">
                  </a>
                </div>
              </li>
              <li class="dt-list__item">
                <div class="choose-option">
                  <a href="../horizontal-bottom-nav" target="_blank" class="choose-option__icon">
                    <img src="images/layouts/horizontal-bottom-nav.png" alt="Horizontal Bottom Nav Layout">
                  </a>
                </div>
              </li>
              <li class="dt-list__item">
                <div class="choose-option">
                  <a href="../horizontal-top-nav" target="_blank" class="choose-option__icon">
                    <img src="images/layouts/horizontal-top-nav.png" alt="Horizontal Top Nav Layout">
                  </a>
                </div>
              </li>
            </ul>
