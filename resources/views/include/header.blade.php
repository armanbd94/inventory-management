                ...
                <div class="dropdown-menu-body ps-custom-scrollbar">
                  ...
                  <div class="h-auto">
                    ...
                    <a href="javascript:void(0)" class="media">
                      ...
                      <!-- Avatar -->
                      <img class="dt-avatar mr-3" src="images/user-avatar/mathew.jpg" alt="User">
                      <!-- avatar -->
                    ...
                    <a href="javascript:void(0)" class="media">
                      ...
                      <!-- Avatar -->
                      <img class="dt-avatar mr-3" src="images/user-avatar/steve-smith.jpg" alt="User">
                      <!-- avatar -->
                    ...
                    <a href="javascript:void(0)" class="media">
                      ...
                      <!-- Avatar -->
                      <img class="dt-avatar mr-3" src="images/user-avatar/domnic-brown.jpg" alt="User">
                      <!-- avatar -->
