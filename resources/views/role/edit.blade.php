            ...
            <div class="dt-card">
                ...
                <div class="dt-card__body">
                    <form id="saveDataForm" method="post">
                        ...
                        <div class="row">
                            <x-form.textbox labelName="Role Name" name="role_name" value="{{ $permission_data['role']->role_name }}" required="required" col="col-md-12" placeholder="Enter role name"/>
                            <div class="col-md-12">
                                                        ...
                                                        <ul>
                                                            @foreach ($menu->permission as $permission)
                                                                <li>
                                                                    ...
                                                                    @if(collect($permission_data['role_permission'])->contains($permission->id)) {{ 'checked' }} @endif/>
                                                                     {{ $permission->name }}
                                                                </li>
                                                            @endforeach
                                                        </ul>
                                                    ...
                                                    <ul>
                                                        @foreach ($menu->submenu as $submenu)
                                                            <li>
                                                                ...
                                                                @if(collect($permission_data['role_module'])->contains($submenu->id)) {{ 'checked' }} @endif> 
                                                                {{ $submenu->module_name }}
                            ...
                            <div class="col-md-12 pt-4">
                                <a href="{{ route('role') }}" class="btn btn-danger btn-sm">Cancel</a>
