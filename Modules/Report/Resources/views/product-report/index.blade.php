                        ...
                        <div class="row justify-content-center">
                            <div class="form-group col-md-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control daterangepicker-filed" value="{{ $start_date.' To '.$end_date }}">
                            ...
                            @if (!empty($product_id))
                                @foreach ($product_id as $key => $pro_id)
                                    <tr>
                                        ...
                                        @php 
                                        if ($warehouse_id == 0) {
                                            $purchased_cost = DB::table('purchase_products')->where('product_id',$pro_id)
                                                                                ->whereDate('created_at','>=',$start_date)
                                                                                ->whereDate('created_at','<=',$end_date)
                                                                                ->sum('total');
                                            $product_purchased_data = DB::table('purchase_products')->where('product_id',$pro_id)
                                                                                ->whereDate('created_at','>=',$start_date)
                                                                                ->whereDate('created_at','<=',$end_date)
                                                                                ->get();
                                            $sold_price = DB::table('sale_products')->where('product_id',$pro_id)
                                                                                ->whereDate('created_at','>=',$start_date)
                                                                                ->whereDate('created_at','<=',$end_date)
                                                                                ->sum('total');
                                            $product_sale_data = DB::table('sale_products')->where('product_id',$pro_id)
                                                                                ->whereDate('created_at','>=',$start_date)
                                                                                ->whereDate('created_at','<=',$end_date)
                                                                                ->get();
                                        }else{
