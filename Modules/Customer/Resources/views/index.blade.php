    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            ...
            <div class="dt-entry__header">
                ...
                <button class="btn btn-primary btn-sm" onclick="showFormModal('Add New Customer','Save')">
                    ...
                    <form id="form-filter">
                        <div class="row">
                            <div class="form-group col-md-3">
                                <label for="customer_group_id">Name</label>
                                <select name="customer_group_id" id="customer_group_id" class="form-control selectpicker" data-live-search="true" 
                            ...
                            <div class="form-group col-md-12 pt-24">
