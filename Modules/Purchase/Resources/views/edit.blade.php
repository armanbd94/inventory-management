                                            ...
                                            @foreach ($purchase->purchase_products as $key => $purchase_product)
                                                <tr>
                                                    ...
                                                    <td><input type="text" class="form-control qty text-center" name="products[{{ $key+1 }}][qty]"
                                                        id="products_{{ $key+1 }}_qty" value="{{ $purchase_product->pivot->qty }}"></td>
                                                        <td class="received-product-qty d-none"><input type="text" class="form-control received text-center"
                                                            name="products[{{ $key+1 }}][received]" value="{{ $purchase_product->pivot->received }}"></td>
