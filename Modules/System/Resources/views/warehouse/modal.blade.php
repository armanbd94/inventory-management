          ...
          @csrf
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <x-form.textbox labelName="Phone No." name="phone" col="col-md-12" placeholder="Enter phone"/>
                    <x-form.textbox type="email" labelName="Email" name="email" col="col-md-12" placeholder="Enter email"/>
